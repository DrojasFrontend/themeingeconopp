        ...
        <div class="container px-lg-3 px-0">
            ...
            <ul class="d-flex justify-content-between gap-3 border-bottom border-secondary-100 pb-3 whitespace-nowrap overflow-x-auto" id="serviciosTabs" role="tablist">
                <li class="" role="presentation">
                    <button class="position-relative nav-link active parrafo text-secondary-100" id="todos-tab" data-bs-toggle="tab" data-bs-target="#todos" type="button" role="tab" aria-controls="todos" aria-selected="true">Todos</button>
                </li>
                <?php foreach ($terms as $index => $term) : ?>
                    <li class="" role="presentation">
                        <button class="position-relative border-0 p-0 parrafo text-secondary-100" id="tab-<?php echo $term->slug; ?>" data-bs-toggle="tab" data-bs-target="#<?php echo $term->slug; ?>" type="button" role="tab" aria-controls="<?php echo $term->slug; ?>" aria-selected="false"><?php echo $term->name; ?></button>
                    </li>
                <?php endforeach; ?>
            </ul>
        </div>
        <div class="container">
            ...
            <div class="tab-content pt-5" id="serviciosTabsContent">
                ...
                <?php foreach ($terms as $term) : ?>
                    <div class="tab-pane fade" id="<?php echo $term->slug; ?>" role="tabpanel" aria-labelledby="tab-<?php echo $term->slug; ?>">
                        <?php
